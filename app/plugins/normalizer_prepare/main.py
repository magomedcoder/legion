...
"""
    Плагин нормализации текста для подготовки входных данных к синтезу речи (русскоязычные TTS-модели)

    Функциональность
        1. Замена неподдерживаемых или нестабильно обрабатываемых символов на их словесные эквиваленты (например, "$" -> "доллар")
        2. Обработка чисел:
    ...
    Назначение:
        Минимизировать ошибки генерации речи в TTS-моделях, которые могут некорректно интерпретировать латиницу, специальные символы и числовые значения.
"""
